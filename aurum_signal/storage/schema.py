...
BATCH_COLUMNS: dict[str, tuple[str, ...]] = {
    ...
    "model_metrics": ("model_id", "ts", "scope", "samples", "accuracy",
                      "win_rate", "brier", "log_loss"),
    "calibration": ("model_id", "ts", "bucket", "samples", "stated", "realised",
                    "ci_low", "ci_high"),
    "booster_metrics": ("booster_id", "ts", "samples", "base_win_rate",
                        "boosted_win_rate", "base_expectancy",
                        "boosted_expectancy", "brier_base", "brier_boosted",
                        "verdict"),
    "strategy_metrics": ("strategy_id", "ts", "scope", "samples", "win_rate",
                         "expectancy", "profit_factor", "max_drawdown",
                         "ci_low", "ci_high", "p_value"),
    "similarity_results": ("decision_id", "setup_id", "ts", "similarity",
                           "historical_win_rate", "samples"),
    "stream_patterns": ("pattern_id", "ts", "regime", "features_before",
                        "order_flow", "direction", "future_return_10s",
                        "future_return_20s", "future_return_30s",
                        "future_return_60s", "success"),
}
